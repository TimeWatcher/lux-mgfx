...
float poly_path_coord(float2 p)
{
	...
	stroke_path_add_segment(p, POLY_V2, POLY_V0, prefix, bestDist, bestCoord);
#elif MGFX_POLY_COUNT == 4
	prefix = stroke_path_add_segment(p, POLY_V0, POLY_V1, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V1, POLY_V2, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V2, POLY_V3, prefix, bestDist, bestCoord);
	stroke_path_add_segment(p, POLY_V3, POLY_V0, prefix, bestDist, bestCoord);
#elif MGFX_POLY_COUNT == 5
	prefix = stroke_path_add_segment(p, POLY_V0, POLY_V1, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V1, POLY_V2, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V2, POLY_V3, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V3, POLY_V4, prefix, bestDist, bestCoord);
	stroke_path_add_segment(p, POLY_V4, POLY_V0, prefix, bestDist, bestCoord);
	...
	stroke_path_add_segment(p, POLY_V5, POLY_V0, prefix, bestDist, bestCoord);
	...
	stroke_path_add_segment(p, POLY_V6, POLY_V0, prefix, bestDist, bestCoord);
#else
	prefix = stroke_path_add_segment(p, POLY_V0, POLY_V1, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V1, POLY_V2, prefix, bestDist, bestCoord);
	prefix = stroke_path_add_segment(p, POLY_V2, POLY_V3, prefix, bestDist, bestCoord);
	...
	stroke_path_add_segment(p, POLY_V7, POLY_V0, prefix, bestDist, bestCoord);
#endif
	return bestCoord;
}
...
float4 main(PS_INPUT i) : COLOR
{
	...
	float pattern = stroke_pattern_mask(poly_path_coord(p), dist, width, POLY_STROKE_KIND, POLY_STROKE_DASH_LENGTH, POLY_STROKE_GAP, POLY_STROKE_OFFSET);
