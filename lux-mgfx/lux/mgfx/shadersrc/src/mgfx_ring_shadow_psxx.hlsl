...
#define SHADOW_SPREAD EXTRA2.w
#define SHADOW_WIDTH EXTRA3.x
#define SHADOW_STRENGTH EXTRA3.y
#define SHADOW_FALLOFF EXTRA3.z
...
{
	float spread = max(SHADOW_SPREAD, 1.0);
