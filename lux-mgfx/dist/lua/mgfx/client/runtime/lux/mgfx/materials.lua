return function(__lux_import)
  ...
  do
    ...
    shaderNames = {
      ...
      image_mask_shadow = "mgfx_image_mask_shadow_ps30",
      ...
      roundrect_shadow = "mgfx_roundrect_shadow_ps30",
      roundrect_outerglow = "mgfx_roundrect_outerglow_ps30",
      chamfer_shadow = "mgfx_chamfer_shadow_ps30",
      ...
      ring_shadow = "mgfx_ring_shadow_ps30",
