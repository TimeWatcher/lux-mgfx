return function(__lux_import)
  ...
  do
    ...
    materialValues = function(key, blurRT)
      ...
      local __lux_tmp_34 = key == "text_face"
      if not __lux_tmp_34 then
        __lux_tmp_34 = key == "text_compose"
      end
  ...
  do
    create = function(owner)
      ...
      local version
      do
        local __lux_tmp_35 = pack.Version
        if __lux_tmp_35 == nil then
          __lux_tmp_35 = ""
        end
        version = __lux_tmp_35
      end
      ...
      state.CreatePageTextMaterials = function(rt)
        local key
        do
          local __lux_tmp_36 = rt ~= nil
          if __lux_tmp_36 then
            __lux_tmp_36 = rt.GetName ~= nil
          end
          if __lux_tmp_36 then
            key = rt:GetName()
          else
  ...
  do
    hasShaders = function(state)
      if renderGetDXLevel ~= nil then
        ...
        local __lux_tmp_37 = dxLevel ~= nil
        if __lux_tmp_37 then
          __lux_tmp_37 = dxLevel < 90
        end
        if __lux_tmp_37 then
          return false
        end
      end
      local __lux_tmp_38 = state ~= nil
      if __lux_tmp_38 then
        __lux_tmp_38 = state.shaderVersion ~= ""
      end
      local __lux_tmp_39 = __lux_tmp_38
      if __lux_tmp_39 then
        __lux_tmp_39 = matOK(state.materials.roundrect)
      end
      return __lux_tmp_39
    end
    shaderStatus = function(state)
      local materials
      do
        local __lux_obj_40 = state
        local __lux_val_41 = nil
        if __lux_obj_40 ~= nil then
          __lux_val_41 = __lux_obj_40.materials
        end
        local __lux_tmp_42 = __lux_val_41
        if __lux_tmp_42 == nil then
          __lux_tmp_42 = {}
        end
        materials = __lux_tmp_42
      end
      local __lux_obj_43 = state
      local __lux_val_44 = nil
      if __lux_obj_43 ~= nil then
        __lux_val_44 = __lux_obj_43.shaderVersion
      end
      local __lux_tmp_45 = __lux_val_44
      if __lux_tmp_45 == nil then
        __lux_tmp_45 = ""
      end
      local __lux_obj_46 = state
      local __lux_val_47 = nil
      if __lux_obj_46 ~= nil then
        __lux_val_47 = __lux_obj_46.shaderMountName
      end
      local __lux_tmp_48 = __lux_val_47
      if __lux_tmp_48 == nil then
        __lux_tmp_48 = "external/custom"
      end
      return {
        loaded = hasShaders(state),
        version = __lux_tmp_45,
        mount = __lux_tmp_48,
  ...
  do
    textureFallbackMaterial = function(texture)
      ...
      local __lux_tmp_49 = makeMaterial ~= nil
      if __lux_tmp_49 then
        __lux_tmp_49 = typeOf(texture) == "string"
      end
      if __lux_tmp_49 then
